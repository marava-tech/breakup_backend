...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // Skip JWT processing for public endpoints or when no Authorization header is present
        ...
        try {
            ...
            // Skip if JWT is empty or malformed
            ...
            // Log the error but don't block the request for malformed JWT tokens
